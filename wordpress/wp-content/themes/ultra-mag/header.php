...
?>
<a class="skip-link screen-reader-text" href="#content"><?php esc_html_e( 'Skip to content', 'ultra-mag' ); ?></a>
<?php 

$preloader = get_theme_mod('ultra_mag_preloader_option','show');
...
if($header_layout == 'default' || $header_layout == ''){
    ...
    $template_id = get_theme_mod('ultra_mag_custom_header');
}
?>
